...
class ZhonghuadushuDownloader(PlatformDownloaderBase):
    ...
    def _get_edition_by_date(self, date: str) -> Optional[EditionInfo]:
        ...
        if not page_urls:
            for page in range(1, 20):
                page_url = f'https://epaper.gmw.cn/{self.PAPER_CODE}/html/layout/{date_formatted}/node_{page:02d}.html'
                page_urls.append(page_url)
        ...
        return EditionInfo(
            ...
            filename=f"中华读书报_{date_str}.pdf",
            date=date,
